...
//-------------- Set the Smp configuration property value -----------------
	def static setSmpConfigProperty(log, context, propName, newValue, waitForApp=false, waitDuration="5", authenticationUser=SYSTEM_USER, authenticationPwd=SYSTEM_PWD){
